...
function r(a, b) {
  ...
  a.Kb = function(d2, e, f) {
    for (var g = Array(arguments.length - 2), m = 2; m < arguments.length; m++)
      g[m - 2] = arguments[m];
    return b.prototype[e].apply(d2, g);
  };
}
function t() {
  this.j = this.j;
...
function Ca(a, b) {
  ...
  for (var e = 1; e < arguments.length; e++) {
    ...
    for (var f = 0; f < Ba.length; f++)
      c = Ba[f], Object.prototype.hasOwnProperty.call(d2, c) && (a[c] = d2[c]);
  }
}
function Da(a) {
  Da[" "](a);
      ...
      for (var m = 0; b == 0 && m < g; m++) {
        ...
        do {
          ...
          if (c[0].length == 0 && d2[0].length == 0)
            break;
          b = ua(c[1].length == 0 ? 0 : parseInt(c[1], 10), d2[1].length == 0 ? 0 : parseInt(d2[1], 10)) || ua(c[2].length == 0, d2[2].length == 0) || ua(c[2], d2[2]);
          c = c[3];
          d2 = d2[3];
        } while (b == 0);
      }
...
ab.prototype.add = function(a, b, c, d2, e) {
  var f = a.toString();
  a = this.a[f];
  a || (a = this.a[f] = [], this.b++);
  var g = bb(a, b, d2, e);
  -1 < g ? (b = a[g], c || (b.Z = false)) : (b = new Za(b, this.src, f, !!d2, e), b.Z = c, a.push(b));
  return b;
};
function cb(a, b) {
  var c = b.type;
  if (c in a.a) {
    var d2 = a.a[c], e = ma(d2, b), f;
    (f = 0 <= e) && Array.prototype.splice.call(d2, e, 1);
    f && ($a(b), a.a[c].length == 0 && (delete a.a[c], a.b--));
  }
}
function bb(a, b, c, d2) {
  for (var e = 0; e < a.length; ++e) {
    var f = a[e];
    if (!f.Y && f.listener == b && f.capture == !!c && f.ca == d2)
      return e;
  }
  return -1;
}
...
function gb(a, b, c, d2, e) {
  ...
  c = ib(c);
  return a && a[A] ? a.va(b, c, n(d2) ? !!d2.capture : !!d2, e) : jb(a, b, c, false, d2, e);
}
function jb(a, b, c, d2, e, f) {
  if (!b)
  ...
  if (a.addEventListener)
    Wa || (e = g), e === void 0 && (e = false), a.addEventListener(b.toString(), d2, e);
  else if (a.attachEvent)
    a.attachEvent(mb(b.toString()), d2);
...
function hb(a, b, c, d2, e) {
  ...
  c = ib(c);
  return a && a[A] ? a.wa(b, c, n(d2) ? !!d2.capture : !!d2, e) : jb(a, b, c, true, d2, e);
}
function ob(a, b, c, d2, e) {
  if (Array.isArray(b))
    for (var f = 0; f < b.length; f++)
      ob(a, b[f], c, d2, e);
  else
    (d2 = n(d2) ? !!d2.capture : !!d2, c = ib(c), a && a[A]) ? (a = a.c, b = String(b).toString(), b in a.a && (f = a.a[b], c = bb(f, c, d2, e), -1 < c && ($a(f[c]), Array.prototype.splice.call(f, c, 1), f.length == 0 && (delete a.a[b], a.b--)))) : a && (a = kb(a)) && (b = a.a[b.toString()], a = -1, b && (a = bb(b, c, d2, e)), (c = -1 < a ? b[a] : null) && pb(c));
}
function pb(a) {
  if (typeof a !== "number" && a && !a.Y) {
    ...
    if (b && b[A])
      ...
      b.removeEventListener ? b.removeEventListener(c, d2, a.capture) : b.detachEvent ? b.detachEvent(mb(c), d2) : b.addListener && b.removeListener && b.removeListener(d2);
...
function nb(a, b) {
  ...
  if (!Ua) {
    if (!b)
      a: {
        b = ["window", "event"];
        for (var c = k, d2 = 0; d2 < b.length; d2++)
          if (c = c[b[d2]], c == null) {
            b = null;
            break a;
          }
...
D.prototype[A] = true;
h = D.prototype;
h.addEventListener = function(a, b, c, d2) {
  gb(this, a, b, c, d2);
};
h.removeEventListener = function(a, b, c, d2) {
  ob(this, a, b, c, d2);
};
function E(a, b) {
  var c, d2 = a.C;
...
h.va = function(a, b, c, d2) {
  return this.c.add(String(a), b, false, c, d2);
};
h.wa = function(a, b, c, d2) {
  return this.c.add(String(a), b, true, c, d2);
};
function tb(a, b, c, d2) {
  b = a.c.a[String(b)];
  if (!b)
    return true;
  b = b.concat();
...
r(F, t);
var Lb = [];
function Mb(a, b, c, d2) {
  Array.isArray(c) || (c && (Lb[0] = c.toString()), c = Lb);
  for (var e = 0; e < c.length; e++) {
    var f = gb(b, c[e], d2 || a.handleEvent, false, a.b || a);
    if (!f)
      break;
    a.a[f.key] = f;
  }
...
function G(a, b, c, d2) {
  a.info(function() {
    return "XMLHTTP TEXT (" + b + "): " + Rb(a, c) + (d2 ? " " + d2 : "");
  });
}
function Sb(a, b) {
  a.info(function() {
...
h.Ca = function(a) {
  try {
    if (a == this.a)
      a: {
        var b = O(this.a), c = this.a.ua(), d2 = this.a.W();
        if (!(3 > b || b == 3 && !Ia && !this.a.$())) {
          this.A || b != 4 || c == 7 || (c == 8 || 0 >= d2 ? I(3) : I(2));
          pc(this);
          var e = this.a.W();
          this.N = e;
          var f = this.a.$();
...
function sc(a, b, c) {
  ...
  b == 4 && c.length == 0 && (a.h = 1, J(16), d2 = false);
  a.b = a.b && d2;
  d2 ? 0 < c.length && !a.V && (a.V = true, b = a.g, b.a == a && b.U && !b.F && (b.c.info("Great, no buffering proxy detected. Bytes received: " + c.length), wc(b), b.F = true, J(11))) : (G(a.c, a.f, c, "[Invalid Chunked Response]"), P(a), rc(a));
}
h.Wa = function() {
  if (this.a) {
  ...
  try {
    ...
    if (c.v != 0 && (c.a == a || zc(c.b, a))) {
      if (c.I = a.N, !a.C && zc(c.b, a) && c.v == 3) {
        ...
        for (b = d2 = c.ka.a.parse(b), d2 = 0; d2 < b.length; d2++)
          if (e = b[d2], c.P = e[0], e = e[1], c.v == 2)
            if (e[0] == "c") {
              c.J = e[1];
              c.ga = e[2];
              var f = e[3];
...
function Mc(a) {
  ...
  if (a.c != a.a.length) {
    ...
    for (c = b = 0; b < a.a.length; )
      d2 = a.a[b], T(e, d2) || (a.a[c++] = d2, e[d2] = 1), b++;
    a.a.length = c;
  }
}
h.get = function(a, b) {
...
h.L = function() {
  V(this);
  for (var a = this.a.K(), b = this.a.L(), c = [], d2 = 0; d2 < b.length; d2++)
...
function $c(a, b) {
  b && !a.f && (V(a), a.c = null, a.a.forEach(function(c, d2) {
    var e = d2.toLowerCase();
    d2 != e && (ed(this, d2), nc(this, e, c));
  }, a));
  a.f = b;
}
var gd = function() {
...
function nd(a, b, c) {
  ...
  try {
    Lc(a, function(e, f) {
      var g = e;
      n(e) && (g = ub(e));
      b.push(d2 + f + "=" + encodeURIComponent(g));
    });
  } catch (e) {
...
function od(a, b) {
  ...
  if (k.Image) {
    var d2 = new Image();
    d2.onload = ja(pd, c, d2, "TestLoadImage: loaded", true, b);
    d2.onerror = ja(pd, c, d2, "TestLoadImage: error", false, b);
    d2.onabort = ja(pd, c, d2, "TestLoadImage: abort", false, b);
    d2.ontimeout = ja(pd, c, d2, "TestLoadImage: timeout", false, b);
    k.setTimeout(function() {
      if (d2.ontimeout)
        d2.ontimeout();
    }, 1e4);
...
h.ba = function(a, b, c, d2) {
  ...
  d2 && Lc(d2, function(f, g) {
    e.set(g, f);
  });
  d2 = oa(e.L());
  c = k.FormData && a instanceof k.FormData;
  !(0 <= ma(td, b)) || d2 || c || e.set("Content-Type", "application/x-www-form-urlencoded;charset=utf-8");
...
function Bd(a, b, c) {
  ...
  d2 || (c = Ad(c), typeof a === "string" ? c != null && encodeURIComponent(String(c)) : R(a, b, c));
}
function Cd(a, b, c) {
  ...
  if (this.h)
    if (this.h = null, this.v == 1) {
      if (!a) {
        ...
        this.da ? (R(e, "$req", d2), R(e, "SID", "null"), b.U = true, jc(b, e, null)) : jc(b, e, d2);
        this.v = 2;
      }
    } else
  ...
  if (a.v != 0) {
    if (b.b)
      if (d2 == 1) {
        ...
        var e = a.u;
        d2 = Ub();
        E(d2, new Xb(d2, c, b, e));
        Ic(a);
      } else
        Hc(a);
    else if (e = b.h, e == 3 || e == 0 && 0 < a.I || !(d2 == 1 && Id(a, b) || d2 == 2 && Cc(a)))
...
function Fc(a, b, c) {
  var d2 = bd(c);
  if (d2.c != "")
    b && Qc(d2, b + "." + d2.c), Rc(d2, d2.h);
  else {
    var e = k.location;
    d2 = cd(e.protocol, b ? b + "." + e.hostname : e.hostname, +e.port, c);
  }
...
// node_modules/@firebase/firestore/dist/esm5/prebuilt-e5399c32-63c92a30.js
/**
 * @license
...
function N2(t2) {
  ...
  if (E2.logLevel <= LogLevel.DEBUG) {
    var i = n2.map(D2);
    E2.debug.apply(E2, __spreadArrays(["Firestore (8.2.6): " + t2], i));
  }
}
function A2(t2) {
  for (var n2 = [], r2 = 1; r2 < arguments.length; r2++)
  ...
  if (E2.logLevel <= LogLevel.ERROR) {
    var i = n2.map(D2);
    E2.error.apply(E2, __spreadArrays(["Firestore (8.2.6): " + t2], i));
  }
}
function S2(t2) {
  for (var n2 = [], r2 = 1; r2 < arguments.length; r2++)
  ...
  if (E2.logLevel <= LogLevel.WARN) {
    var i = n2.map(D2);
    E2.warn.apply(E2, __spreadArrays(["Firestore (8.2.6): " + t2], i));
  }
}
function D2(t2) {
  if (typeof t2 == "string")
...
function x2(t2) {
  ...
  var e = "FIRESTORE (8.2.6) INTERNAL ASSERTION FAILED: " + t2;
...
F2.UNAUTHENTICATED = new F2(null), F2.R = new F2("google-credentials-uid"), F2.P = new F2("first-party-uid");
/**
 * @license
 * Copyright 2017 Google LLC
 *
...
var G2 = function() {
  ...
  return t2.prototype.getToken = function() {
    ...
    this.V = t3, t3(F2.UNAUTHENTICATED);
...
var B = function() {
  function t2(t3) {
    var e = this;
    this.D = null, this.currentUser = F2.UNAUTHENTICATED, this.C = false, this.N = 0, this.V = null, this.forceRefresh = false, this.D = function() {
      e.N++, e.currentUser = e.F(), e.C = true, e.V && e.V(e.currentUser);
  ...
  }, t2.prototype.F = function() {
    var t3 = this.auth && this.auth.getUid();
    return k2(t3 === null || typeof t3 == "string"), new F2(t3);
  }, t2;
}();
var Q2 = function() {
  function t2(t3, e) {
    this.O = t3, this.k = e, this.type = "FirstParty", this.user = F2.P;
  }
...
var Y2 = function() {
  ...
  return t2.prototype.getToken = function() {
    return Promise.resolve(new Q2(this.O, this.k));
  }, t2.prototype.v = function(t3) {
    t3(F2.P);
  }, t2.prototype.S = function() {
  }, t2.prototype.p = function() {
...
var H2 = function() {
  function t2(t3, e) {
    var n2 = this;
    this.previousValue = t3, e && (e.M = function(t4) {
      return n2.L(t4);
    }, this.$ = function(t4) {
      return e.B(t4);
    });
...
var it = function() {
  ...
  return t2.prototype.Tt = function(t3) {
    ...
    return C(this.fields, t3.fields, function(t4, e) {
      return t4.isEqual(e);
    });
  }, t2;
}();
...
function yt(t2, e) {
  ...
  switch (n2) {
    ...
    case 9:
      return C(t2.arrayValue.values || [], e.arrayValue.values || [], yt);
    case 10:
      return function(t3, e2) {
...
function gt(t2, e) {
  ...
  switch (n2) {
    ...
    case 8:
      return function(t3, e2) {
        var n3 = V2(st(t3.latitude), st(e2.latitude));
        return n3 !== 0 ? n3 : V2(st(t3.longitude), st(e2.longitude));
...
function wt(t2, e) {
  if (typeof t2 == "string" && typeof e == "string" && t2.length === e.length)
    return V2(t2, e);
  var n2 = ut(t2), r2 = ut(e), i = V2(n2.seconds, r2.seconds);
  ...
  return t2.empty = function() {
    ...
    for (var e = this.proto, n2 = 0; n2 < t3.length - 1; ++n2) {
      if (!e.mapValue.fields)
        return null;
      if (!St(e = e.mapValue.fields[t3.get(n2)]))
        return null;
    }
...
var xt = function() {
  function t2(t3) {
    t3 === void 0 && (t3 = Dt.empty()), this.It = t3, this.At = new Map();
  }
  return t2.prototype.set = function(t3, e) {
    ...
    return t3 != null ? new Dt(t3) : this.It;
  }, t2.prototype.yt = function(t3, e) {
    var n2 = this, r2 = false, i = this.It.field(t3), o = St(i) ? Object.assign({}, i.mapValue.fields) : {};
...
var Ct = function(t2, e, n2, r2, i, o, u) {
...
function Rt(t2, e, n2, r2, i, o, u) {
  return e === void 0 && (e = null), n2 === void 0 && (n2 = []), r2 === void 0 && (r2 = []), i === void 0 && (i = null), o === void 0 && (o = null), u === void 0 && (u = null), new Ct(t2, e, n2, r2, i, o, u);
}
function Ut(t2) {
  var e = O2(t2);
  if (e.vt === null) {
...
var jt = function(t2) {
  ...
  return __extends(e, t2), e.create = function(t3, n2, r2) {
    return t3.ut() ? n2 === "in" || n2 === "not-in" ? this.St(t3, n2, r2) : new Ft(t3, n2, r2) : n2 === "array-contains" ? new Qt(t3, r2) : n2 === "in" ? new Yt(t3, r2) : n2 === "not-in" ? new Ht(t3, r2) : n2 === "array-contains-any" ? new Kt(t3, r2) : new e(t3, n2, r2);
...
var ee = function(t2, e, n2, r2, i, o, u, s) {
  e === void 0 && (e = null), n2 === void 0 && (n2 = []), r2 === void 0 && (r2 = []), i === void 0 && (i = null), o === void 0 && (o = "F"), u === void 0 && (u = null), s === void 0 && (s = null), this.path = t2, this.collectionGroup = e, this.xt = n2, this.filters = r2, this.limit = i, this.limitType = o, this.startAt = u, this.endAt = s, this.Nt = null, this.Ft = null, this.startAt, this.endAt;
};
...
function he(t2) {
  ...
  if (!e.Ft)
    if (e.limitType === "F")
      e.Ft = Rt(e.path, e.collectionGroup, ce(e), e.filters, e.limit, e.startAt, e.endAt);
    else {
      ...
      e.Ft = Rt(e.path, e.collectionGroup, n2, e.filters, e.limit, s, a);
    }
  return e.Ft;
}
function fe(t2, e, n2) {
...
var ge = function() {
  function t2(t3, e, n2, r2, i, o, u) {
    i === void 0 && (i = X2.min()), o === void 0 && (o = X2.min()), u === void 0 && (u = U2.T), this.target = t3, this.targetId = e, this.Ot = n2, this.sequenceNumber = r2, this.kt = i, this.lastLimboFreeSnapshotVersion = o, this.resumeToken = u;
  }
  return t2.prototype.Mt = function(e) {
    return new t2(this.target, this.targetId, this.Ot, e, this.kt, this.lastLimboFreeSnapshotVersion, this.resumeToken);
  }, t2.prototype.Lt = function(e, n2) {
    return new t2(this.target, this.targetId, this.Ot, this.sequenceNumber, n2, this.lastLimboFreeSnapshotVersion, e);
  }, t2.prototype.$t = function(e) {
    return new t2(this.target, this.targetId, this.Ot, this.sequenceNumber, this.kt, e, this.resumeToken);
  }, t2;
}();
/**
 * @license
...
function Ee(t2, e, n2) {
  ...
  }(n2, e) : t2 instanceof Se ? De(t2, e) : t2 instanceof xe ? ke(t2, e) : function(t3, e2) {
    var n3 = Ne(t3, e2), r2 = Pe(n3) + Pe(t3.Ut);
    return Et(n3) && Et(t3.Ut) ? be(r2) : we(t3.Qt, r2);
  }(t2, e);
}
function Te(t2, e, n2) {
  return t2 instanceof Se ? De(t2, e) : t2 instanceof xe ? ke(t2, e) : n2;
}
function Ne(t2, e) {
...
function De(t2, e) {
  for (var n2 = Le(e), r2 = function(t3) {
    n2.some(function(e2) {
      return yt(e2, t3);
    }) || n2.push(t3);
...
function qe(t2, e, n2) {
  return t2 instanceof Be ? function(t3, e2, n3) {
    ...
    return new Lt(t3.key, n3.version, {
      hasCommittedMutations: true
    });
  }(t2, 0, n2);
}
function je(t2, e, n2) {
  return t2 instanceof Be ? function(t3, e2, n3) {
    ...
    return Ue(t3.jt, e2) ? new Lt(t3.key, X2.min()) : e2;
  }(t2, e);
}
function Fe(t2, e) {
  return function(t3, e2) {
...
function ze(t2, e) {
  return t2.type === e.type && !!t2.key.isEqual(e.key) && !!t2.jt.isEqual(e.jt) && !!function(t3, e2) {
    return t3 === void 0 && e2 === void 0 || !(!t3 || !e2) && C(t3, e2, function(t4, e3) {
      return function(t5, e4) {
        return t5.field.isEqual(e4.field) && function(t6, e5) {
          return t6 instanceof Se && e5 instanceof Se || t6 instanceof xe && e5 instanceof xe ? C(t6.elements, e5.elements, yt) : t6 instanceof Oe && e5 instanceof Oe ? yt(t6.Ut, e5.Ut) : t6 instanceof Ae && e5 instanceof Ae;
...
function Ye(t2, e, n2) {
  ...
  }(t2, r2 = e instanceof Pt ? e.data() : Dt.empty()), r2 = Xe(t2.fieldTransforms, r2, n2);
}
function He(t2, e, n2) {
  var r2 = [];
...
var En = function() {
  function t2(t3, e, n2, r2, i) {
    this.kt = t3, this.Fe = e, this.Oe = n2, this.ke = r2, this.Me = i;
  }
  return t2.Le = function(e, n2) {
    var r2 = new Map();
    return r2.set(e, Tn.$e(e, n2)), new t2(X2.min(), r2, wn(), hn(), mn());
  }, t2;
}();
var Tn = function() {
  function t2(t3, e, n2, r2, i) {
...
var xn = function() {
  function t2(t3) {
    this.un = t3, this.hn = new Map(), this.ln = hn(), this._n = kn(), this.fn = new sn(V2);
  }
  return t2.prototype.dn = function(t3) {
    for (var e = 0, n2 = t3.Ke; e < n2.length; e++) {
      var r2 = n2[e];
      t3.We instanceof Pt ? this.wn(r2, t3.We) : t3.We instanceof Lt && this.En(r2, t3.key, t3.We);
    }
    ...
    this.hn.forEach(function(r3, i2) {
      ...
      if (o) {
        if (r3.Be && qt(o.target)) {
          ...
          e.ln.get(u) !== null || e.pn(i2, u) || e.En(i2, u, new Lt(u, t3));
        }
    ...
    this._n.forEach(function(t4, n3) {
      ...
      n3.Ae(function(t5) {
        var n4 = e.yn(t5);
        return !n4 || n4.Ot === 2 || (i2 = false, false);
      }), i2 && (r2 = r2.add(t4));
    });
    var i = new En(t3, n2, this.fn, this.ln, r2);
    return this.ln = hn(), this._n = kn(), this.fn = new sn(V2), i;
    ...
    return e || (e = new Dn(), this.hn.set(t3, e)), e;
  }, t2.prototype.bn = function(t3) {
    var e = this._n.get(t3);
    return e || (e = new sn(V2), this._n = this._n.zt(t3, e)), e;
    ...
    var e = this;
    this.hn.set(t3, new Dn()), this.un.vn(t3).forEach(function(n2) {
      e.En(t3, n2, null);
    });
...
function Kn(t2, e, n2) {
  var r2 = zn(t2, e.name), i = Mn(e.updateTime), o = new Dt({
    mapValue: {
      fields: e.fields
    }
  });
...
function Wn(t2, e) {
  ...
  if (e.update) {
    e.update.name;
    var i = zn(t2, e.update.name), o = new Dt({
      mapValue: {
...
function sr(t2) {
  return jt.create(ur(t2.fieldFilter.field), function(t3) {
    switch (t3) {
      case "EQUAL":
        return "==";
      case "NOT_EQUAL":
...
var lr = function() {
  ...
  return t2.prototype.catch = function(t3) {
    ...
    var r2 = this;
    return this.Nn && x2(), this.Nn = true, this.xn ? this.error ? this.Fn(n2, this.error) : this.On(e, this.result) : new t2(function(t3, i) {
      r2.Dn = function(n3) {
        r2.On(e, n3).next(t3, i);
      }, r2.Cn = function(e2) {
        r2.Fn(n2, e2).next(t3, i);
      };
    });
  }, t2.prototype.kn = function() {
    var t3 = this;
    return new Promise(function(e, n2) {
      t3.next(e, n2);
    });
  }, t2.prototype.Mn = function(e) {
    try {
      var n2 = e();
...
var dr = function() {
  ...
  return t2.delete = function(t3) {
    return N2("SimpleDb", "Removing database:", t3), wr(window.indexedDB.deleteDatabase(t3)).kn();
  }, t2.Kn = function() {
...
function Ar(t2) {
  for (var e = "", n2 = 0; n2 < t2.length; n2++)
    e.length > 0 && (e = Dr(e)), e = Sr(t2.get(n2), e);
  return Dr(e);
}
function Sr(t2, e) {
...
var Lr = function(t2, e, n2, r2, i) {
  this.userId = t2, this.batchId = e, this.localWriteTimeMs = n2, this.baseMutations = r2, this.mutations = i;
};
Lr.store = "mutations", Lr.keyPath = "batchId", Lr.userMutationsIndex = "userMutationsIndex", Lr.userMutationsKeyPath = ["userId", "batchId"];
var Vr = function() {
  function t2() {
  }
...
Vr.store = "documentMutations", Vr.PLACEHOLDER = new Vr();
...
var Yr = __spreadArrays(__spreadArrays(__spreadArrays(__spreadArrays([Pr.store, Lr.store, Vr.store, Ur.store, qr.store, Or.store, Fr.store, jr.store], [Gr.store]), [Mr.store]), [zr.store]), [Br.store, Qr.store]);
var Hr = function(t2) {
  function e(e2, n2) {
    var r2 = this;
...
var Xr = function() {
  ...
  return t2.prototype.Ss = function(t3, e, n2) {
    ...
    for (var n2 = 0, r2 = this.baseMutations; n2 < r2.length; n2++) {
      (u = r2[n2]).key.isEqual(t3) && (e = je(u, e, this.vs));
    }
    for (var i = 0, o = this.mutations; i < o.length; i++) {
      var u;
      (u = o[i]).key.isEqual(t3) && (e = je(u, e, this.vs));
    }
    return e;
    ...
    return this.batchId === t3.batchId && C(this.mutations, t3.mutations, function(t4, e) {
      return ze(t4, e);
    }) && C(this.baseMutations, t3.baseMutations, function(t4, e) {
      return ze(t4, e);
    });
  }, t2;
}();
var Wr = function() {
  function t2(t3, e, n2, r2) {
    this.batch = t3, this.Ns = e, this.Ds = n2, this.Fs = r2;
  }
...
function Jr(t2, e) {
  if (e.document)
    return Kn(t2.Os, e.document, !!e.hasCommittedMutations);
  if (e.noDocument) {
  ...
  if (e instanceof Pt) {
    var o = function(t3, e2) {
      return {
        ...
        updateTime: Cn(t3, e2.version.j())
      };
    }(t2.Os, e), u = e.hasCommittedMutations;
    return new Ur(null, null, o, u, r2, i);
  }
  if (e instanceof Lt) {
    var s = e.key.path.it(), a = ni(e.version);
    u = e.hasCommittedMutations;
    return new Ur(null, new Cr(s, a), null, u, r2, i);
  }
  if (e instanceof Vt) {
...
function ui(t2, e) {
  var n2, r2 = ni(e.kt), i = ni(e.lastLimboFreeSnapshotVersion);
  n2 = qt(e.target) ? Zn(t2.Os, e.target) : Jn(t2.Os, e.target);
...
var ai = function() {
  ...
  return t2.prototype.ks = function(t3, e) {
 ...
 */
function bi(t2, e, n2) {
  var r2 = t2.store(Lr.store), i = t2.store(Vr.store), o = [], u = IDBKeyRange.only(n2.batchId), s = 0, a = r2.hs({
    range: u
  }, function(t3, e2, n3) {
    return s++, n3.delete();
  });
  ...
  for (var c = [], h2 = 0, f = n2.mutations; h2 < f.length; h2++) {
    var l = f[h2], p2 = Vr.key(e, l.key.path, n2.batchId);
  ...
  return t2.mi = function(e, n2, r2, i) {
    ...
    return u.add({}).next(function(s) {
      ...
      for (var a = new Xr(s, e, n2, r2), c = function(t4, e2, n3) {
        ...
        return new Lr(e2, n3.batchId, n3.vs.toMillis(), r3, i2);
      }(i.Qt, i.userId, a), h2 = [], f = new sn(function(t4, e2) {
        return V2(t4.rt(), e2.rt());
      }), l = 0, p2 = r2; l < p2.length; l++) {
        var d2 = p2[l], v2 = Vr.key(i.userId, d2.key.path, s);
        f = f.add(d2.key.path.X()), h2.push(u.put(c)), h2.push(o.put(v2, Vr.PLACEHOLDER));
      }
      return f.forEach(function(e2) {
        h2.push(i.Ei.qs(t3, e2));
      }), t3.gs(function() {
        i.Ii[s] = a.keys();
      }), lr.Ln(h2).next(function() {
        return a;
      });
    });
    ...
    return Ti(t3).rs(Lr.userMutationsIndex, n2).next(function(t4) {
      return t4.map(function(t5) {
        return ii(e.Qt, t5);
      });
    });
  }, t2.prototype.bi = function(t3, e) {
    var n2 = this, r2 = Vr.prefixForPath(this.userId, e.path), i = IDBKeyRange.lowerBound(r2), o = [];
    return Ni(t3).hs({
      range: i
    }, function(r3, i2, u) {
    ...
    var n2 = this, r2 = new sn(V2), i = [];
    return e.forEach(function(e2) {
      var o = Vr.prefixForPath(n2.userId, e2.path), u = IDBKeyRange.lowerBound(o), s = Ni(t3).hs({
        range: u
      }, function(t4, i2, o2) {
    ...
    var n2 = this, r2 = e.path, i = r2.length + 1, o = Vr.prefixForPath(this.userId, r2), u = IDBKeyRange.lowerBound(o), s = new sn(V2);
    return Ni(t3).hs({
      range: u
    }, function(t4, e2, o2) {
    ...
    return this.Ai(t3).next(function(n2) {
      if (!n2)
        return lr.resolve();
      var r2 = IDBKeyRange.lowerBound(Vr.prefixForUser(e.userId)), i = [];
      return Ni(t3).hs({
        range: r2
      }, function(t4, n3, r3) {
        if (t4[0] === e.userId) {
...
function Ei(t2, e, n2) {
  var r2 = Vr.prefixForPath(e, n2.path), i = r2[1], o = IDBKeyRange.lowerBound(r2), u = false;
  return Ni(t2).hs({
    range: o,
    us: true
  }, function(t3, n3, r3) {
...
var Di = function() {
  ...
  return t2.prototype.Bi = function(t3) {
    ...
    return this.qi(t3).next(function(n2) {
      var r2 = new Si(n2.highestTargetId);
    ...
    return ki(t3).get(Fr.key).next(function(t4) {
      return k2(t4 !== null), t4;
    });
  }, t2.prototype.Ui = function(t3, e) {
    return ki(t3).put(Fr.key, e);
  }, t2.prototype.Gi = function(t3, e) {
    ...
    return e.forEach(function(e2) {
      var u = Ar(e2.path);
      i.push(o.put(new jr(n2, u))), i.push(r2.Ti.nr(t3, n2, e2));
    }), lr.Ln(i);
  }, t2.prototype.sr = function(t3, e, n2) {
    var r2 = this, i = Oi(t3);
    return lr.forEach(e, function(e2) {
      var o = Ar(e2.path);
      return lr.Ln([i.delete([n2, o]), r2.Ti.ir(t3, n2, e2)]);
    });
  }, t2.prototype.Yi = function(t3, e) {
 ...
 */
function Pi(t2, e) {
  var n2 = t2[0], r2 = t2[1], i = e[0], o = e[1], u = V2(n2, i);
  return u === 0 ? V2(r2, o) : u;
}
var Li = function() {
  function t2(t3) {
...
var Ri = function() {
  ...
  return t2.prototype.Rr = function(t3) {
    ...
    var n2 = this, r2 = this.db.Fr().Nr(), i = [], o = 0;
    ...
    return this.db.Fr().kr(t3);
  }, t2;
}();
function Ui(t2, e) {
  return Oi(t2).put(function(t3, e2) {
    return new jr(0, Ar(t3.path), e2);
  }(e, t2.bs));
}
/**
 * @license
...
var Mi = function() {
  ...
  return t2.prototype.ai = function(t3, e, n2) {
    return Fi(t3).put(zi(e), n2);
  }, t2.prototype.li = function(t3, e) {
    var n2 = Fi(t3), r2 = zi(e);
    return n2.delete(r2);
  }, t2.prototype.updateMetadata = function(t3, e) {
    var n2 = this;
    return this.getMetadata(t3).next(function(r2) {
      return r2.byteSize += e, n2.Mr(t3, r2);
    });
  }, t2.prototype._i = function(t3, e) {
    var n2 = this;
    return Fi(t3).get(zi(e)).next(function(t4) {
      return n2.Lr(t4);
    });
    ...
    return Fi(t3).hs(u, function(t4, n3, u2) {
      if (t4.length === o) {
        var s2 = Jr(r2.Qt, n3);
    ...
    return ji(t3).get(Mr.key).next(function(t4) {
      return k2(!!t4), t4;
    });
  }, t2.prototype.Mr = function(t3, e) {
    return ji(t3).put(Mr.key, e);
  }, t2.prototype.Lr = function(t3) {
    if (t3) {
      var e = Jr(this.Qt, t3);
      return e instanceof Lt && e.version.isEqual(X2.min()) ? null : e;
    }
    return null;
  }, t2;
}();
  ...
  return __extends(e, t2), e.prototype.wi = function(t3) {
    ...
    return this.ri.forEach(function(o, u) {
      ...
      if (u.hi) {
        ...
        var h2 = $r(e2.jr.Qt, new Lt(o, X2.min()), e2.ci(o));
        n2.push(e2.jr.ai(t3, o, h2));
      } else
        n2.push(e2.jr.li(t3, o));
    }), i.forEach(function(r3) {
      n2.push(e2.jr.Ei.qs(t3, r3));
    }), n2.push(this.jr.updateMetadata(t3, r2)), lr.Ln(n2);
  }, e.prototype.fi = function(t3, e2) {
    var n2 = this;
    return this.jr.$r(t3, e2).next(function(t4) {
...
var Gi = function() {
  ...
  return t2.prototype.Jn = function(t3, e, n2, r2) {
    ...
    return n2 < 3 && r2 >= 3 && (n2 !== 0 && (function(t4) {
      t4.deleteObjectStore(jr.store), t4.deleteObjectStore(qr.store), t4.deleteObjectStore(Fr.store);
    }(t3), Bi(t3)), u = u.next(function() {
      return function(t4) {
        var e2 = t4.store(Fr.store), n3 = new Fr(0, 0, X2.min().j(), 0);
        return e2.put(Fr.key, n3);
      }(o);
    })), n2 < 4 && r2 >= 4 && (n2 !== 0 && (u = u.next(function() {
      return function(t4, e2) {
        return e2.store(Lr.store).rs().next(function(n3) {
          t4.deleteObjectStore(Lr.store), t4.createObjectStore(Lr.store, {
            keyPath: Lr.keyPath,
            autoIncrement: true
          }).createIndex(Lr.userMutationsIndex, Lr.userMutationsKeyPath, {
            unique: true
          });
          var r3 = e2.store(Lr.store), i2 = n3.map(function(t5) {
            return r3.put(t5);
          });
          return lr.Ln(i2);
        });
    ...
    var e = this, n2 = t3.store(Pr.store), r2 = t3.store(Lr.store);
    return n2.rs().next(function(n3) {
      return lr.forEach(n3, function(n4) {
        ...
        return r2.rs(Lr.userMutationsIndex, i).next(function(r3) {
    ...
    var e = t3.store(jr.store), n2 = t3.store(Ur.store);
      ...
      return n2.hs(function(n3, i) {
        ...
        r2.push(e.get(u).next(function(n4) {
          return n4 ? lr.resolve() : function(n5) {
            return e.put(new jr(0, Ar(n5), t4.highestListenSequenceNumber));
          }(o);
        }));
      }).next(function() {
        return lr.Ln(r2);
...
var Yi = function() {
  function t2(e, n2, r2, i, o, u, s, a, c, h2) {
    ...
    this.Ti = new Ri(this, i), this.ho = n2 + "main", this.Qt = new Zr(a), this.lo = new dr(this.ho, 11, new Gi(this.Qt)), this._o = new Di(this.Ti, this.Qt), this.Ei = new pi(), this.fo = function(t3, e2) {
      return new Mi(t3, e2);
  ...
  return t2.prototype.start = function() {
          ...
          case 0:
            return !this.isPrimary || this.No(this.ao, 18e5) ? [3, 2] : (this.ao = Date.now(), [4, this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", function(t4) {
              ...
              return e2.rs().next(function(t5) {
                var n3 = i.Fo(t5, 18e5), r3 = t5.filter(function(t6) {
          ...
          case 1:
            if (t3 = o.sent(), this.Eo)
              for (e = 0, n2 = t3; e < n2.length; e++)
                r2 = n2[e], this.Eo.removeItem(this.Oo(r2.clientId));
            o.label = 2;
          case 2:
            return [2];
        }
    ...
    return this.no ? lr.resolve(true) : Hi(t3).get(Or.key).next(function(n2) {
      if (n2 !== null && e.No(n2.leaseTimestampMs, 5e3) && !e.ko(n2.ownerId)) {
      ...
      return !(!e.networkEnabled || !e.inForeground) || Ki(t3).rs().next(function(t4) {
        return e.Fo(t4, 5e3).find(function(t5) {
    ...
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(e) {
        switch (e.label) {
          case 0:
            return this.io = false, this.Lo(), this.co && (this.co.cancel(), this.co = null), this.$o(), this.Bo(), [4, this.lo.runTransaction("shutdown", "readwrite", [Or.store, Gr.store], function(e2) {
    ...
    return t3.filter(function(t4) {
      return n2.No(t4.updateTimeMs, e) && !n2.ko(t4.clientId);
    });
  }, t2.prototype.Uo = function() {
    var t3 = this;
    return this.runTransaction("getActiveClients", "readonly", function(e) {
      return Ki(e).rs().next(function(e2) {
        return t3.Fo(e2, 18e5).map(function(t4) {
          return t4.clientId;
        });
      });
    });
    ...
    var e = this;
    return Hi(t3).get(Or.key).next(function(t4) {
      if (t4 !== null && e.No(t4.leaseTimestampMs, 5e3) && !e.ko(t4.ownerId) && !e.Do(t4) && !(e.no || e.allowTabSynchronization && t4.allowTabSynchronization))
        throw new q2(M2.FAILED_PRECONDITION, Qi);
    });
    ...
    var e;
    try {
      var n2 = ((e = this.Eo) === null || e === void 0 ? void 0 : e.getItem(this.Oo(t3))) !== null;
  ...
  return t2.prototype.Ho = function(t3, e) {
    ...
    return this.zo.vi(t3, e).next(function(r2) {
      ...
      return i.forEach(function(t4, e2) {
        e2 || (e2 = new Lt(t4, X2.min())), o = o.zt(t4, e2);
      }), o;
    });
  }, t2.prototype.Kr = function(t3, e, n2) {
    return function(t4) {
      ...
      return i = e2, o.sc(t3, i, r2).next(function(t4) {
        ...
        for (var e3 = 0, n3 = i; e3 < n3.length; e3++)
          for (var o2 = n3[e3], u = 0, s = o2.mutations; u < s.length; u++) {
            var a = s[u], c = a.key, h2 = je(a, r2.get(c), o2.vs);
...
var to = function() {
  function t2(t3, e, n2, r2) {
    this.persistence = t3, this._c = e, this.Qt = r2, this.fc = new rn(V2), this.dc = new gi(function(t4) {
      return Ut(t4);
    }, Mt), this.wc = X2.min(), this.zo = t3.Qo(n2), this.Ec = t3.Fr(), this._o = t3.Sr(), this.Tc = new Zi(this.Ec, this.zo, this.persistence.Ko()), this.wo = t3.Wo(), this._c.cc(this.Tc);
  }
        ...
        case 0:
          return n2 = O2(t2), r2 = n2.zo, i = n2.Tc, [4, n2.persistence.runTransaction("Handle user change", "readonly", function(t3) {
            ...
            return n2.zo.pi(t3).next(function(u2) {
              ...
              for (var p2 = 0, d2 = e2; p2 < d2.length; p2++) {
                var v2 = d2[p2];
                r3.push(v2.batchId);
  ...
  return n2.persistence.runTransaction("Apply remote event", "readwrite-primary", function(t3) {
    ...
    e.Fe.forEach(function(e2, o2) {
      ...
      if (s2) {
        ...
        if (a2.l() > 0) {
          var c = s2.Lt(a2, r2).Mt(t3.bs);
          i = i.zt(o2, c), function(t4, e3, n3) {
            return k2(e3.resumeToken.l() > 0), t4.resumeToken.l() === 0 || (e3.kt.W() - t4.kt.W() >= 3e8 || n3.qe.size + n3.Ue.size + n3.Qe.size > 0);
          }(s2, c, e2) && u.push(n2._o.Hi(t3, c));
        }
      }
    });
    var s = hn();
    if (e.ke.forEach(function(r3, i2) {
      e.Me.has(r3) && u.push(n2.persistence.Ti.Or(t3, r3));
    }), u.push(uo(t3, o, e.ke, r2, void 0).next(function(t4) {
      s = t4;
    })), !r2.isEqual(X2.min())) {
...
function uo(t2, e, n2, r2, i) {
  ...
  return n2.forEach(function(t3) {
    ...
    return n2.forEach(function(n3, u) {
      ...
      u instanceof Lt && u.version.isEqual(X2.min()) ? (e.li(n3, a), o2 = o2.zt(n3, u)) : s == null || u.version._(s.version) > 0 || u.version._(s.version) === 0 && s.hasPendingWrites ? (e.ai(u, a), o2 = o2.zt(n3, u)) : N2("LocalStore", "Ignoring outdated watch update for ", n3, ". Current version:", s.version, " Watch version:", u.version);
    }), o2;
  });
}
function so(t2, e) {
...
function ao(t2, e) {
  ...
  return n2.persistence.runTransaction("Allocate target", "readwrite", function(t3) {
    ...
    return (r2 === null || t3.kt._(r2.kt) > 0) && (n2.fc = n2.fc.zt(t3.targetId, t3), n2.dc.set(e, t3.targetId)), t3;
  });
}
function co(t2, e, n2) {
  return __awaiter(this, void 0, void 0, function() {
...
function lo(t2) {
  ...
  return e.persistence.runTransaction("Get new document changes", "readonly", function(t3) {
    return function(t4, e2, n2) {
      var r2 = O2(t4), i = hn(), o = ti(n2), u = Fi(e2), s = IDBKeyRange.lowerBound(o, true);
      return u.hs({
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(d2) {
      switch (d2.label) {
        ...
        case 1:
          return p2 = d2.sent(), [2, i.persistence.runTransaction("Apply bundle documents", "readwrite", function(t3) {
...
var wo = function() {
  function t2(t3, e) {
    this.key = t3, this.Lc = e;
  }
  return t2.Sc = function(t3, e) {
    return tt.H(t3.key, e.key) || V2(t3.Lc, e.Lc);
  }, t2.Cc = function(t3, e) {
    return V2(t3.Lc, e.Lc) || tt.H(t3.key, e.key);
  }, t2;
}();
var bo = function() {
  function t2(t3, e) {
    this.Ei = t3, this.Ti = e, this.zo = [], this.$c = 1, this.Bc = new sn(wo.Sc);
  }
  return t2.prototype.Ai = function(t3) {
    ...
    return lr.resolve(this.zo.length === 0 ? -1 : this.$c - 1);
  }, t2.prototype.pi = function(t3) {
    ...
    tt.wt(i) || (i = i.child(""));
    var o = new wo(new tt(i), 0), u = new sn(V2);
    return this.Bc.Ae(function(t4) {
      var e2 = t4.key.path;
      return !!n2.nt(e2) && (e2.length === r2 && (u = u.add(t4.Lc)), true);
...
var Eo = function() {
  function t2(t3) {
    this.persistence = t3, this.Gc = new gi(function(t4) {
      return Ut(t4);
    }, Mt), this.lastRemoteSnapshotVersion = X2.min(), this.highestTargetId = 0, this.zc = 0, this.Hc = new go(), this.targetCount = 0, this.Jc = Si.Li();
  }
  return t2.prototype.In = function(t3, e) {
    ...
    var e = t3.targetId;
    e > this.highestTargetId && (this.Jc = new Si(e), this.highestTargetId = e), t3.sequenceNumber > this.zc && (this.zc = t3.sequenceNumber);
  }, t2.prototype.ji = function(t3, e) {
...
var To = function() {
  ...
  return t2.prototype.start = function() {
    ...
    return lr.$n(Object.values(this.Yc).map(function(n2) {
      return function() {
        return n2.Oi(t3, e);
      };
    }));
...
var Ao = function() {
  ...
  return t2.ia = function(e) {
    ...
    var n2 = this;
    this.na.Oc(e.targetId).forEach(function(t4) {
    ...
    var e = this, n2 = this.persistence.Fr().Nr();
    ...
    return lr.$n([function() {
      return lr.resolve(n2.na.Oi(e));
    }, function() {
      return n2.persistence.Sr().Oi(t3, e);
    }, function() {
...
var ko = function() {
  ...
  return t2.ca = function(e, n2, r2) {
    var i = JSON.parse(r2), o = typeof i == "object" && ["pending", "acknowledged", "rejected"].indexOf(i.state) !== -1 && (i.error === void 0 || typeof i.error == "object"), u = void 0;
    return o && i.error && ((o = typeof i.error.message == "string" && typeof i.error.code == "string") && (u = new q2(i.error.code, i.error.message))), o ? new t2(e, n2, i.state, u) : (A2("SharedClientState", "Failed to parse mutation state for ID '" + n2 + "': " + r2), null);
...
var Oo = function() {
  ...
  return t2.ca = function(e, n2) {
    ...
    return i && r2.error && ((i = typeof r2.error.message == "string" && typeof r2.error.code == "string") && (o = new q2(r2.error.code, r2.error.message))), i ? new t2(e, r2.state, o) : (A2("SharedClientState", "Failed to parse target state for ID '" + e + "': " + n2), null);
  }, t2.prototype.aa = function() {
    var t3 = {
      state: this.state,
      updateTimeMs: Date.now()
...
var Co = function() {
  function t2(t3, e, n2, r2, i) {
    this.window = t3, this.Zr = e, this.persistenceKey = n2, this.la = r2, this._a = null, this.fa = null, this.M = null, this.da = this.wa.bind(this), this.Ea = new rn(V2), this.Er = false, this.Ta = [];
    var o = n2.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
    this.storage = this.window.localStorage, this.currentUser = i, this.Ia = So(this.persistenceKey, this.la), this.ma = function(t4) {
      return "firestore_sequence_number_" + t4;
    }(this.persistenceKey), this.Ea = this.Ea.zt(this.la, new Vo()), this.Aa = new RegExp("^firestore_clients_" + o + "_([^_]*)$"), this.Ra = new RegExp("^firestore_mutations_" + o + "_(\\d+)(?:_(.*))?$"), this.Pa = new RegExp("^firestore_targets_" + o + "_(\\d+)$"), this.ya = function(t4) {
  ...
  return t2.Kn = function(t3) {
        ...
        switch (l.label) {
          ...
          case 1:
            for (t3 = l.sent(), e = 0, n2 = t3; e < n2.length; e++)
              (r2 = n2[e]) !== this.la && (i = this.getItem(So(this.persistenceKey, r2))) && (o = Po.ca(r2, i)) && (this.Ea = this.Ea.zt(o.clientId, o));
    ...
    return this.ka.ua(t3), this.Va(), e;
  }, t2.prototype.Ma = function(t3) {
    this.ka.ha(t3), this.Va();
  }, t2.prototype.La = function(t3) {
    return this.ka.activeTargetIds.has(t3);
  ...
  }, Object.defineProperty(t2.prototype, "ka", {
    get: function() {
    ...
    var r2 = new ko(this.currentUser, t3, e, n2), i = Do(this.persistenceKey, this.currentUser, t3);
    this.setItem(i, r2.aa());
  }, t2.prototype.Fa = function(t3) {
    var e = Do(this.persistenceKey, this.currentUser, t3);
    this.removeItem(e);
...
var Fo = function(t2) {
  ...
  return __extends(e, t2), e.prototype.Su = function(t3, e2, n2, r2) {
    ...
    var g = c.createWebChannel(m, f), w2 = false, b = false, _2 = new jo({
      fu: function(t4) {
    ...
    return I3(g, WebChannel.EventType.OPEN, function() {
      b || N2("Connection", "WebChannel transport opened.");
    }), I3(g, WebChannel.EventType.CLOSE, function() {
      b || (b = true, N2("Connection", "WebChannel transport closed"), _2.Ru());
    }), I3(g, WebChannel.EventType.ERROR, function(t4) {
      b || (b = true, S2("Connection", "WebChannel transport errored:", t4), _2.Ru(new q2(M2.UNAVAILABLE, "The operation could not be completed")));
    }), I3(g, WebChannel.EventType.MESSAGE, function(t4) {
      var e3;
      if (!b) {
        var n3 = t4.data[0];
        k2(!!n3);
    ...
    }), I3(h2, Event.STAT_EVENT, function(t4) {
  ...
  return t2.prototype.pu = function(t3, e, n2, r2) {
    ...
    return this.vu(o, r2), this.Su(t3, i, o, n2).then(function(t4) {
      ...
      throw S2("RestConnection", t3 + " failed with error: ", e2, "url: ", i, "request:", n2), e2;
    });
  }, t2.prototype.Du = function(t3, e, n2, r2) {
    return this.pu(t3, e, n2, r2);
  }, t2.prototype.vu = function(t3, e) {
    if (t3["X-Goog-Api-Client"] = "gl-js/ fire/8.2.6", t3["Content-Type"] = "text/plain", e)
      for (var n2 in e.g)
...
var Qo = function() {
  function t2(t3, e, n2, r2, i) {
    n2 === void 0 && (n2 = 1e3), r2 === void 0 && (r2 = 1.5), i === void 0 && (i = 6e4), this.Zr = t3, this.fs = e, this.xu = n2, this.Nu = r2, this.Fu = i, this.Ou = 0, this.ku = null, this.Mu = Date.now(), this.reset();
  }
  return t2.prototype.reset = function() {
    ...
    var e = this;
    this.cancel();
    var n2 = Math.floor(this.Ou + this.Bu()), r2 = Math.max(0, Date.now() - this.Mu), i = Math.max(0, n2 - r2);
    i > 0 && N2("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.Ou + " ms, delay with jitter: " + n2 + " ms, last attempt: " + r2 + " ms ago)"), this.ku = this.Zr.Tr(this.fs, i, function() {
      return e.Mu = Date.now(), t3();
    }), this.Ou *= this.Nu, this.Ou < this.xu && (this.Ou = this.xu), this.Ou > this.Fu && (this.Ou = this.Fu);
  }, t2.prototype.qu = function() {
    this.ku !== null && (this.ku.Rs(), this.ku = null);
  }, t2.prototype.cancel = function() {
    this.ku !== null && (this.ku.cancel(), this.ku = null);
  }, t2.prototype.Bu = function() {
    return (Math.random() - 0.5) * this.Ou;
  }, t2;
}();
var Yo = function() {
  ...
  return t2.prototype.zu = function() {
    ...
    return __awaiter(this, void 0, void 0, function() {
      return __generator(this, function(n2) {
        switch (n2.label) {
          case 0:
            return this.eh(), this.Gu.cancel(), this.Wu++, t3 !== 3 ? this.Gu.reset() : e && e.code === M2.RESOURCE_EXHAUSTED ? (A2(e.toString()), A2("Using maximum backoff delay to prevent overloading the backend."), this.Gu.Lu()) : e && e.code === M2.UNAUTHENTICATED && this.Ku.p(), this.stream !== null && (this.nh(), this.stream.close(), this.stream = null), this.state = t3, [4, this.listener.Tu(e)];
          case 1:
            return n2.sent(), [2];
        }
      });
    ...
    var t3 = this;
    this.state = 4, this.Gu.$u(function() {
  ...
  return __extends(e, t2), e.prototype.oh = function(t3) {
    ...
    var e2 = function(t4, e3) {
      ...
      if ("targetChange" in e3) {
        ...
        e3.documentDelete, (r2 = e3.documentDelete).document, i = zn(t4, r2.document), o = r2.readTime ? Mn(r2.readTime) : X2.min(), s = new Lt(i, o), u = r2.removedTargetIds || [], n3 = new Nn([], u, s.key, s);
    ...
    e2.database = Qn(this.Qt), e2.addTarget = function(t4, e3) {
      ...
      return (n3 = qt(r2) ? {
        ...
        query: Jn(t4, r2)
      }).targetId = e3.targetId, e3.resumeToken.l() > 0 ? n3.resumeToken = Rn(t4, e3.resumeToken) : e3.kt._(X2.min()) > 0 && (n3.readTime = Cn(t4, e3.kt.j())), n3;
    }(this.Qt, t3);
      ...
      var e2 = function(t4, e3) {
        return t4 && t4.length > 0 ? (k2(e3 !== void 0), t4.map(function(t5) {
          return function(t6, e4) {
            ...
            var r2 = null;
            return t6.transformResults && t6.transformResults.length > 0 && (r2 = t6.transformResults), new Ce(n3, r2);
          }(t5, e3);
        })) : [];
...
var Zo = function(t2, e, n2, r2, i) {
  var o = this;
  this.bh = t2, this.Sh = e, this._s = n2, this.Dh = {}, this.Ch = [], this.xh = new Map(), this.Nh = new Set(), this.Fh = [], this.Oh = i, this.Oh.ou(function(t3) {
    n2.Ps(function() {
                ...
                return __awaiter(this, void 0, void 0, function() {
                  ...
                  return __generator(this, function(n3) {
                    switch (n3.label) {
                      ...
                      case 1:
                        return n3.sent(), e2.kh.set("Unknown"), e2.Nh.delete(4), [4, Jo(e2)];
                      case 2:
                        return n3.sent(), [2];
                    }
                  });
...
function eu(t2, e) {
  ...
  n2.xh.delete(e), r2.Hu() && ru(n2, e), n2.xh.size === 0 && (r2.Hu() ? r2.Xu() : uu(n2) && n2.kh.set("Unknown"));
}
function nu(t2, e) {
  t2.Mh.on(e.targetId), _u(t2).uh(e);
}
function ru(t2, e) {
  t2.Mh.on(e), _u(t2).hh(e);
}
function iu(t2) {
  t2.Mh = new xn({
    vn: function(e) {
...
function cu(t2, e) {
  return __awaiter(this, void 0, void 0, function() {
    return __generator(this, function(n2) {
      return su(t2), ou(t2) ? (t2.kh.Vh(e), iu(t2)) : t2.kh.set("Unknown"), [2];
    });
  });
}
function hu(t2, e, n2) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(u) {
      switch (u.label) {
        case 0:
          if (t2.kh.set("Online"), !(e instanceof Sn && e.state === 2 && e.cause))
            return [3, 6];
          u.label = 1;
        case 1:
              ...
              return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(u2) {
                  switch (u2.label) {
                    ...
                    case 1:
                      return r3 < i2.length ? (o2 = i2[r3], t3.xh.has(o2) ? [4, t3.Dh.Lh(o2, n3)] : [3, 3]) : [3, 5];
                    case 2:
                      u2.sent(), t3.xh.delete(o2), t3.Mh.removeTarget(o2), u2.label = 3;
                    case 3:
                      u2.label = 4;
                    case 4:
                      return r3++, [3, 1];
        ...
        case 5:
          return [3, 13];
        case 6:
          if (e instanceof Nn ? t2.Mh.dn(e) : e instanceof An ? t2.Mh.Pn(e) : t2.Mh.Tn(e), n2.isEqual(X2.min()))
            return [3, 13];
          u.label = 7;
        case 7:
        ...
        case 8:
          return i = u.sent(), n2._(i) >= 0 ? [
            ...
            function(t3, e2) {
              var n3 = t3.Mh.Vn(e2);
              return n3.Fe.forEach(function(n4, r3) {
                if (n4.resumeToken.l() > 0) {
                  var i2 = t3.xh.get(r3);
                  i2 && t3.xh.set(r3, i2.Lt(n4.resumeToken, e2));
                }
              }), n3.Oe.forEach(function(e3) {
                var n4 = t3.xh.get(e3);
                if (n4) {
                  t3.xh.set(e3, n4.Lt(U2.T, n4.kt)), ru(t3, e3);
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(i) {
      switch (i.label) {
        ...
        case 1:
          return i.sent(), t2.kh.set("Offline"), n2 || (n2 = function() {
            return io(t2.bh);
          }), t2._s.po(function() {
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(i) {
      switch (i.label) {
        ...
        case 3:
          i.sent(), r2 = n2.kh.set("Unknown"), i.label = 4;
        case 4:
          r2, i.label = 5;
        case 5:
          return [2];
...
function _u(t2) {
  ...
  return t2.Uh || (t2.Uh = function(t3, e2, n2) {
    ...
    Tu: cu.bind(null, t2),
    ah: hu.bind(null, t2)
  }), t2.Fh.push(function(n2) {
    return __awaiter(e, void 0, void 0, function() {
      return __generator(this, function(e2) {
        switch (e2.label) {
          case 0:
            return n2 ? (t2.Uh.Yu(), ou(t2) ? iu(t2) : t2.kh.set("Unknown"), [3, 3]) : [3, 1];
          case 1:
            return [4, t2.Uh.stop()];
          case 2:
...
var Pu = function() {
  ...
  return t2.prototype.Pc = function(t3) {
    ...
    return t3.metadata.exists ? Kn(this.Qt, t3.document, false) : new Lt(this.Pc(t3.metadata.name), this.gc(t3.metadata.readTime));
...
var Lu = function() {
  function t2(t3, e, n2) {
    this.il = t3, this.bh = e, this.Qt = n2, this.queries = [], this.documents = [], this.progress = Vu(t3);
  }
...
var Uu = function() {
  ...
  return Object.defineProperty(t2.prototype, "_l", {
    ...
    if (t3.Xt(function(t4, e2) {
      ...
      var l = !!h3 && n2.De.has(h3.key), p2 = !!f && (f.Vt || n2.De.has(f.key) && f.hasCommittedMutations), d2 = false;
      h3 && f ? h3.data().isEqual(f.data()) ? l !== p2 && (r2.track({
        type: 3,
        doc: f
      }), d2 = true) : n2.wl(h3, f) || (r2.track({
        type: 2,
        doc: f
      }), d2 = true, (a && n2.hl(f, a) > 0 || c && n2.hl(f, c) < 0) && (s = true)) : !h3 && f ? (r2.track({
        type: 0,
        doc: f
      }), d2 = true) : h3 && !f && (r2.track({
        type: 1,
        doc: h3
      }), d2 = true, (a || c) && (s = true)), d2 && (f ? (u = u.add(f), o = p2 ? o.add(t4) : o.delete(t4)) : (u = u.delete(t4), o = o.delete(t4)));
...
var ju = function() {
  function t2(t3, e, n2, r2, i, o) {
    this.bh = t3, this.yl = e, this.gl = n2, this.Vl = r2, this.currentUser = i, this.pl = o, this.bl = {}, this.vl = new gi(function(t4) {
      return pe(t4);
    }, le), this.Sl = new Map(), this.Dl = [], this.Cl = new rn(tt.H), this.xl = new Map(), this.Nl = new go(), this.Fl = {}, this.Ol = new Map(), this.kl = Si.$i(), this.onlineState = "Unknown", this.Ml = void 0;
  }
  return Object.defineProperty(t2.prototype, "Ll", {
    get: function() {
      return this.Ml === true;
    },
    enumerable: false,
...
function Fu(t2, e) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(a) {
      switch (a.label) {
        case 0:
          return n2 = ys(t2), (o = n2.vl.get(e)) ? (r2 = o.targetId, n2.Vl.Oa(r2), i = o.view.Rl(), [3, 4]) : [3, 1];
        case 1:
          return [4, ao(n2.bh, he(e))];
        case 2:
          return u = a.sent(), s = n2.Vl.Oa(u.targetId), r2 = u.targetId, [4, zu(n2, e, r2, s === "current")];
        case 3:
          i = a.sent(), n2.Ll && tu(n2.yl, u), a.label = 4;
        case 4:
          return [2, i];
      }
    });
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(h2) {
      switch (h2.label) {
              ...
              return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(s2) {
                  switch (s2.label) {
                    ...
                    case 2:
                      return o2 = r4 && r4.Fe.get(e3.targetId), u2 = e3.view.wi(i2, t3.Ll, o2), [2, (es(t3, e3.targetId, u2.Il), u2.snapshot)];
                  }
                });
              });
            }(t2, e2, n3, r3);
        ...
        case 1:
          return i = h2.sent(), o = new Uu(e, i.Rc), u = o.fl(i.documents), s = Tn.$e(n2, r2 && t2.onlineState !== "Offline"), a = o.wi(u, t2.Ll, s), es(t2, n2, a.Il), c = new Mu(e, n2, o), [2, (t2.vl.set(e, c), t2.Sl.has(n2) ? t2.Sl.get(n2).push(e) : t2.Sl.set(n2, [e]), a.snapshot)];
      }
    });
  });
}
      ...
      switch (o.label) {
        case 0:
          return n2 = O2(t2), r2 = n2.vl.get(e), (i = n2.Sl.get(r2.targetId)).length > 1 ? [2, (n2.Sl.set(r2.targetId, i.filter(function(t3) {
            return !le(t3, e);
          })), void n2.vl.delete(e))] : n2.Ll ? (n2.Vl.Ma(r2.targetId), n2.Vl.Da(r2.targetId) ? [3, 2] : [4, co(n2.bh, r2.targetId, false).then(function() {
            n2.Vl.$a(r2.targetId), eu(n2.yl, r2.targetId), $u(n2, r2.targetId);
          }).catch(mi)]) : [3, 3];
        case 1:
          o.sent(), o.label = 2;
        case 2:
      ...
      switch (s.label) {
            ...
            return r3.persistence.runTransaction("Locally write mutations", "readwrite", function(t4) {
              return r3.Tc.Xo(t4, o2).next(function(o3) {
                ...
                for (var u2 = [], s2 = 0, a = e2; s2 < a.length; s2++) {
                  var c = a[s2], h2 = Fe(c, n3.get(c.key));
        ...
        case 2:
          return i = s.sent(), r2.Vl.Ca(i.batchId), function(t3, e2, n3) {
            var r3 = t3.Fl[t3.currentUser.A()];
            r3 || (r3 = new rn(V2)), r3 = r3.zt(e2, n3), t3.Fl[t3.currentUser.A()] = r3;
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(i) {
      switch (i.label) {
        ...
        case 2:
          return r2 = i.sent(), e.Fe.forEach(function(t3, e2) {
            var r3 = n2.xl.get(e2);
...
function Yu(t2, e, n2) {
  ...
  if (r2.Ll && n2 === 0 || !r2.Ll && n2 === 1) {
    ...
    }(r2.gl, e), i.length && r2.bl.ah(i), r2.onlineState = e, r2.Ll && r2.Vl.Qa(e);
  }
}
function Hu(t2, e, n2) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(c) {
      switch (c.label) {
        case 0:
          return (r2 = O2(t2)).Vl.Ba(e, "rejected", n2), i = r2.xl.get(e), (o = i && i.key) ? (u = (u = new rn(tt.H)).zt(o, new Lt(o, X2.min())), s = mn().add(o), a = new En(X2.min(), new Map(), new sn(V2), u, s), [4, Qu(r2, a)]) : [3, 2];
        case 1:
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(s) {
      switch (s.label) {
        ...
        case 2:
          return (r2 = s.sent()) === -1 ? [2, void e.resolve()] : ((i = n2.Ol.get(r2) || []).push(e), n2.Ol.set(r2, i), [3, 4]);
        case 3:
...
function Zu(t2, e) {
  (t2.Ol.get(e) || []).forEach(function(t3) {
    t3.resolve();
  }), t2.Ol.delete(e);
}
function Ju(t2, e, n2) {
  var r2 = O2(t2), i = r2.Fl[r2.currentUser.A()];
  if (i) {
    var o = i.get(e);
    o && (n2 ? o.reject(n2) : o.resolve(), i = i.remove(e)), r2.Fl[r2.currentUser.A()] = i;
  }
}
function $u(t2, e, n2) {
  n2 === void 0 && (n2 = null), t2.Vl.Ma(e);
  for (var r2 = 0, i = t2.Sl.get(e); r2 < i.length; r2++) {
    var o = i[r2];
    t2.vl.delete(o), n2 && t2.bl.Bl(o, n2);
  }
  t2.Sl.delete(e), t2.Ll && t2.Nl.Oc(e).forEach(function(e2) {
    t2.Nl.Oi(e2) || ts(t2, e2);
  });
}
function ts(t2, e) {
  var n2 = t2.Cl.get(e);
...
function es(t2, e, n2) {
  for (var r2 = 0, i = n2; r2 < i.length; r2++) {
    var o = i[r2];
    o instanceof Cu ? (t2.Nl.nr(o.key, e), ns(t2, o)) : o instanceof Ru ? (N2("SyncEngine", "Document no longer in limbo: " + o.key), t2.Nl.ir(o.key, e), t2.Nl.Oi(o.key) || ts(t2, o.key)) : x2();
  }
}
function ns(t2, e) {
  var n2 = e.key;
  t2.Cl.get(n2) || (N2("SyncEngine", "New document in limbo: " + n2), t2.Dl.push(n2), rs(t2));
}
function rs(t2) {
  for (; t2.Dl.length > 0 && t2.Cl.size < t2.pl; ) {
    var e = t2.Dl.shift(), n2 = t2.kl.next();
    t2.xl.set(n2, new qu(e)), t2.Cl = t2.Cl.zt(e, n2), tu(t2.yl, new ge(he(re(e.path)), n2, 2, H2.q));
  }
}
function is(t2, e, n2) {
  return __awaiter(this, void 0, void 0, function() {
      ...
      switch (s.label) {
        case 0:
          return r2 = O2(t2), i = [], o = [], u = [], r2.vl.et() ? [3, 3] : (r2.vl.forEach(function(t3, s2) {
            u.push(r2.$l(s2, e, n2).then(function(t4) {
              if (t4) {
                r2.Ll && r2.Vl.Ba(s2.targetId, t4.fromCache ? "not-current" : "current"), i.push(t4);
                ...
                switch (f.label) {
                  ...
                  case 4:
                    for (i2 = 0, o2 = e2; i2 < o2.length; i2++)
                      u2 = o2[i2], s2 = u2.targetId, u2.fromCache || (a = n3.fc.get(s2), c = a.kt, h2 = a.$t(c), n3.fc = n3.fc.zt(s2, h2));
                    return [2];
                }
              });
            });
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(o) {
      switch (o.label) {
        ...
        case 1:
          return r2 = o.sent(), i = e.view.Al(r2), [2, (n2.Ll && es(n2, e.targetId, i.Il), i)];
      }
    });
  });
}
...
function hs(t2, e) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(h2) {
      switch (h2.label) {
        case 0:
          return ys(n2 = O2(t2)), ms(n2), e !== true || n2.Ml === true ? [3, 3] : (r2 = n2.Vl.va(), [4, fs(n2, r2.it())]);
        case 1:
          return i = h2.sent(), n2.Ml = true, [4, bu(n2.yl, true)];
        case 2:
          for (h2.sent(), o = 0, u = i; o < u.length; o++)
            s = u[o], tu(n2.yl, s);
          return [3, 7];
        case 3:
          return e !== false || n2.Ml === false ? [3, 7] : (a = [], c = Promise.resolve(), n2.Sl.forEach(function(t3, e2) {
            n2.Vl.La(e2) ? a.push(e2) : c = c.then(function() {
        ...
        case 5:
          return h2.sent(), function(t3) {
            ...
            e2.xl.forEach(function(t4, n3) {
              eu(e2.yl, n3);
            }), e2.Nl.kc(), e2.xl = new Map(), e2.Cl = new rn(tt.H);
          }(n2), n2.Ml = false, [4, bu(n2.yl, false)];
        case 6:
          h2.sent(), h2.label = 7;
        case 7:
          return [2];
...
function fs(t2, e, n2) {
  return __awaiter(this, void 0, void 0, function() {
    var n3, r2, i, o, u, s, a, c, h2, f, l, p2, d2, v2;
    return __generator(this, function(y2) {
      switch (y2.label) {
        ...
        case 4:
          (d2 = y2.sent()).snapshot && i.push(d2.snapshot), y2.label = 5;
        case 5:
          return h2++, [3, 3];
        case 6:
          return [3, 11];
...
function ds(t2, e, n2, r2) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(s) {
      switch (s.label) {
        case 0:
          return (i = O2(t2)).Ml ? (N2("SyncEngine", "Ignoring unexpected query state notification."), [3, 8]) : [3, 1];
        case 1:
          if (!i.Sl.has(e))
            return [3, 8];
          switch (n2) {
        ...
        case 2:
          return [4, lo(i.bh)];
        case 3:
          return o = s.sent(), u = En.Le(e, n2 === "current"), [4, is(i, o, u)];
        case 4:
          return s.sent(), [3, 8];
        case 5:
  ...
  return t2.prototype.initialize = function(t3) {
    ...
    return __awaiter(this, void 0, void 0, function() {
      return __generator(this, function(t3) {
        switch (t3.label) {
          case 0:
            return this.Gl && this.Gl.stop(), [4, this.Vl.Mo()];
          case 1:
            return t3.sent(), [4, this.persistence.Mo()];
          case 2:
            return t3.sent(), [2];
        }
      });
...
var _s = function(t2) {
  ...
  return __extends(e, t2), e.prototype.initialize = function(e2) {
      ...
      return __generator(this, function(i) {
        switch (i.label) {
          case 0:
            return [4, t2.prototype.initialize.call(this, e2)];
          case 1:
            return i.sent(), n2 = this.Yl._a, this.Vl instanceof Co ? (this.Vl._a = {
              eu: cs.bind(null, n2),
              nu: ds.bind(null, n2),
              su: vs.bind(null, n2),
              Uo: ps.bind(null, n2),
    ...
    return new Co(e2, t3._s, n2, t3.clientId, t3.Jl);
  }, e;
}(bs);
var Is = function() {
  function t2() {
  ...
  return t2.prototype.initialize = function(t3, e) {
      ...
      return __generator(this, function(r2) {
        switch (r2.label) {
          case 0:
            ...
            }, this.yl.Dh.n_ = os.bind(null, this._a), [4, bu(this.yl, this._a.Ll)]);
          case 1:
            r2.sent(), r2.label = 2;
          case 2:
            return [2];
    ...
    var e, n2 = Bo(t3.yu.t), r2 = (e = t3.yu, new Fo(e));
    return function(t4, e2, n3) {
    ...
    return function(t4, e2, n2, r2, i, o, u) {
      var s = new ju(t4, e2, n2, r2, i, o);
      return u && (s.Ml = true), s;
      ...
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(n2) {
          switch (n2.label) {
            ...
            case 1:
              return n2.sent(), e.Oh.Mo(), e.kh.set("Unknown"), [2];
          }
        });
      });
    }(this.yl);
...
var zs = function(t2) {
  ...
  return __extends(e, t2), Object.defineProperty(e.prototype, "id", {
    ...
    get: function() {
      var t3 = this.D_.X();
      return t3.et() ? null : new js(this.firestore, null, new tt(t3));
    },
    enumerable: false,
    configurable: true
...
function Gs(t2, e) {
  for (var n2, r2 = [], i = 2; i < arguments.length; i++)
    r2[i - 2] = arguments[i];
  if (t2 instanceof Ds && (t2 = t2.d_), xs("collection", "path", e), t2 instanceof qs)
    return Ls(n2 = Z2.ot.apply(Z2, __spreadArrays([e], r2))), new zs(t2, null, n2);
  if (!(t2 instanceof js || t2 instanceof zs))
  ...
  return Ls(n2 = Z2.ot.apply(Z2, __spreadArrays([t2.path], r2)).child(Z2.ot(e))), new zs(t2.firestore, null, n2);
}
function Bs(t2, e) {
  for (var n2, r2 = [], i = 2; i < arguments.length; i++)
    r2[i - 2] = arguments[i];
  if (t2 instanceof Ds && (t2 = t2.d_), arguments.length === 1 && (e = L2.u()), xs("doc", "path", e), t2 instanceof qs)
    return Ps(n2 = Z2.ot.apply(Z2, __spreadArrays([e], r2))), new js(t2, null, new tt(n2));
  if (!(t2 instanceof js || t2 instanceof zs))
    throw new q2(M2.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
  return Ps(n2 = t2.D_.child(Z2.ot.apply(Z2, __spreadArrays([e], r2)))), new js(t2.firestore, t2 instanceof zs ? t2.v_ : null, new tt(n2));
}
function Qs(t2, e) {
  return t2 instanceof Ds && (t2 = t2.d_), e instanceof Ds && (e = e.d_), (t2 instanceof js || t2 instanceof zs) && (e instanceof js || e instanceof zs) && t2.firestore === e.firestore && t2.path === e.path && t2.v_ === e.v_;
}
function Ys(t2, e) {
  return t2 instanceof Ds && (t2 = t2.d_), e instanceof Ds && (e = e.d_), t2 instanceof Fs && e instanceof Fs && t2.firestore === e.firestore && le(t2.C_, e.C_) && t2.v_ === e.v_;
}
var Hs = function() {
  function t2(t3, e) {
  ...
  return Object.defineProperty(t2.prototype, "latitude", {
    ...
    return V2(this.x_, t3.x_) || V2(this.N_, t3.N_);
  }, t2;
}();
var Ks = /^__.*__$/;
var Xs = function() {
...
function ca2(t2, e, n2, r2, i, o) {
  ...
  for (var h2 = [], f = new xt(), l = s.length - 1; l >= 0; --l)
    if (!wa(h2, s[l])) {
      var p2 = s[l], d2 = a[l];
      d2 instanceof Ds && (d2 = d2.d_);
      var v2 = u.U_(p2);
      if (d2 instanceof na2)
        h2.push(p2);
      else {
        var y2 = fa2(d2, v2);
...
function fa2(t2, e) {
  if (t2 instanceof Ds && (t2 = t2.d_), pa2(t2))
  ...
  return function(t3, e2) {
    if (t3 instanceof Ds && (t3 = t3.d_), t3 === null)
      return {
        nullValue: "NULL_VALUE"
      };
    if (typeof t3 == "number")
    ...
    throw e2.K_("Unsupported field value: " + Vs(t3));
  }(t2, e);
}
function la(t2, e) {
  var n2 = {};
...
function pa2(t2) {
  return !(typeof t2 != "object" || t2 === null || t2 instanceof Array || t2 instanceof Date || t2 instanceof K2 || t2 instanceof Hs || t2 instanceof j || t2 instanceof js || t2 instanceof Ss);
}
...
function va(t2, e, n2) {
  if (e instanceof Ds && (e = e.d_), e instanceof As)
    return e.f_;
  if (typeof e == "string")
    return ma2(t2, e);
        ...
        switch (r2.label) {
                      ...
                      return o = a.sent(), u = new Map(), o.forEach(function(t5) {
                        var e3 = function(t6, e4) {
                          return "found" in e4 ? function(t7, e5) {
                            ...
                            var n4 = zn(t7, e5.found.name), r4 = Mn(e5.found.updateTime), i2 = new Dt({
                              mapValue: {
          ...
          case 1:
            return [2, ((e = r2.sent()).forEach(function(t4) {
              t4 instanceof Lt || t4 instanceof Pt ? n2.sf(t4) : x2();
            }), e)];
        }
      });
    });
...
var Ia2 = function() {
  function t2(t3, e, n2) {
    var r2 = this;
    this.credentials = t3, this._s = e, this.yu = n2, this.user = F2.UNAUTHENTICATED, this.clientId = L2.u(), this._f = function() {
                ...
                return __awaiter(this, void 0, void 0, function() {
                  ...
                  return __generator(this, function(i2) {
                    switch (i2.label) {
                      ...
                      case 1:
                        return i2.sent(), r3 && n4.kh.set("Unknown"), [4, n4.Dh.n_(e2)];
                      case 2:
    ...
    return __generator(this, function(r2) {
      switch (r2.label) {
        case 0:
          return [4, Aa2(t2)];
        case 1:
          return e = r2.sent(), [2, ((n2 = e.gl).jh = Fu.bind(null, e._a), n2.Hh = Gu.bind(null, e._a), n2)];
      }
    });
  });
}
    ...
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(n2) {
        switch (n2.label) {
          ...
          case 4:
            this.Pf.length > 0 && this.Gu.$u(function() {
              return e.Cf();
            }), n2.label = 5;
          case 5:
            return [2];
...
var Ra2 = function() {
  ...
  return t2.prototype.onProgress = function(t3, e, n2) {
    ...
    return this.Lf.promise.catch(t3);
  }, t2.prototype.then = function(t3, e) {
    return this.Lf.promise.then(t3, e);
  }, t2.prototype.ql = function(t3) {
    this.Ul(t3), this.Mf.complete && this.Mf.complete(), this.Lf.resolve(t3);
  }, t2.prototype.Kl = function(t3) {
    this.$f.taskState = "Error", this.Mf.next && this.Mf.next(this.$f), this.Mf.error && this.Mf.error(t3), this.Lf.reject(t3);
  }, t2.prototype.Ul = function(t3) {
    this.$f = t3, this.Mf.next && this.Mf.next(t3);
  }, t2;
}();
var Ua2 = -1;
var Ma2 = function(t2) {
  function e(e2, n2) {
    var r2 = this;
    return (r2 = t2.call(this, e2, n2) || this).Bf = new Va2(), r2.w_ = "name" in e2 ? e2.name : "[DEFAULT]", r2;
  }
  return __extends(e, t2), e.prototype.b_ = function() {
    return this.qf || ja2(this), this.qf.terminate();
  }, e;
}(qs);
/**
 * @license
 ...
 */
function qa2(t2) {
  return t2.qf || ja2(t2), t2.qf.df(), t2.qf;
}
function ja2(t2) {
 ...
 */
function Ya2(t2, e) {
  return typeof e == "string" ? ma2(t2, e) : e instanceof Ds ? e.d_.f_ : e.f_;
}
/**
 * @license
 * Copyright 2020 Google LLC
...
var Wa2 = function(t2) {
  ...
  return __extends(e, t2), e.prototype.td = function(t3) {
    ...
    return new Fs(t3.firestore, t3.v_, function(t4, e3) {
...
var Ja2 = function(t2) {
  ...
  return __extends(e, t2), e.prototype.td = function(t3) {
    return new Fs(t3.firestore, t3.v_, fe(t3.C_, this.od, this.ad));
  }, e;
}(Ka2);
var $a2 = function(t2) {
  function e(e2, n2, r2) {
...
function ec2(t2, e, n2, r2) {
  if (n2[0] instanceof Ds && (n2[0] = n2[0].d_), n2[0] instanceof Ba2)
...
function nc2(t2, e, n2) {
  if (n2 instanceof Ds && (n2 = n2.d_), typeof n2 == "string") {
    if (n2 === "")
  ...
  if (n2 instanceof js)
    return It(t2, n2.S_);
  throw new q2(M2.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + Vs(n2) + ".");
}
function rc2(t2, e) {
...
var uc2 = function(t2) {
  ...
  return __extends(e, t2), e.prototype.Wf = function(t3) {
    ...
    return new js(this.firestore, null, e2);
  }, e;
}(Ga2);
var sc2 = function() {
  function t2(t3, e) {
...
function dc2(t2, e, n2) {
  for (var r2 = [], i = 3; i < arguments.length; i++)
    r2[i - 3] = arguments[i];
  t2 = Cs(t2, js);
  var o = Cs(t2.firestore, Ma2), u = ta2(o);
  return e instanceof Ds && (e = e.d_), yc2(o, [(typeof e == "string" || e instanceof As ? ca2(u, "updateDoc", t2.S_, e, n2, r2) : aa2(u, "updateDoc", t2.S_, e)).F_(t2.S_, Re.exists(true))]);
}
function vc2(t2) {
  for (var e, n2, r2, i = [], o = 1; o < arguments.length; o++)
    i[o - 1] = arguments[o];
  t2 instanceof Ds && (t2 = t2.d_);
  var u = {
    includeMetadataChanges: false
  }, s = 0;
  typeof i[s] != "object" || Ca2(i[s]) || (u = i[s], s++);
  var a, c, h2, f = {
  ...
  if (t2 instanceof js)
    c = Cs(t2.firestore, Ma2), h2 = re(t2.S_.path), a = {
      next: function(e2) {
        i[s] && i[s](mc2(c, t2, e2));
      },
      error: i[s + 1],
    ...
    var p2 = Cs(t2, Fs);
    c = Cs(p2.firestore, Ma2), h2 = p2.C_;
    var d2 = new pc2(c);
    a = {
      next: function(t3) {
        i[s] && i[s](new hc2(c, d2, p2, t3));
      },
      error: i[s + 1],
      complete: i[s + 2]
    }, Ha2(t2.C_);
...
var gc2 = function() {
  ...
  return t2.prototype.set = function(t3, e, n2) {
    ...
    return e instanceof Ds && (e = e.d_), o = typeof e == "string" || e instanceof As ? ca2(this.Id, "WriteBatch.update", u.S_, e, n2, r2) : aa2(this.Id, "WriteBatch.update", u.S_, e), this.Ed.push(o.F_(u.S_, Re.exists(true))), this;
  }, t2.prototype.delete = function(t3) {
    this.md();
...
function wc2(t2, e) {
  if (t2 instanceof Ds && (t2 = t2.d_), t2.firestore !== e)
...
var bc2 = function(t2) {
  ...
  return t2.prototype.get = function(t3) {
    ...
    for (var r2 = [], i = 3; i < arguments.length; i++)
      r2[i - 3] = arguments[i];
    var o, u = wc2(t3, this.Yf);
    return e instanceof Ds && (e = e.d_), o = typeof e == "string" || e instanceof As ? ca2(this.Id, "Transaction.update", u.S_, e, n2, r2) : aa2(this.Id, "Transaction.update", u.S_, e), this.Ad.update(u.S_, o), this;
  }, t2.prototype.delete = function(t3) {
    var e = wc2(t3, this.Yf);
...
var Ec2 = function(t2) {
  ...
  return __extends(e, t2), e.fromBase64String = function(t3) {
    return Ic2(), new e(j.fromBase64String(t3));
  }, e.fromUint8Array = function(t3) {
    return _c(), new e(j.fromUint8Array(t3));
...
var Tc2 = function() {
  ...
  return t2.prototype.enableIndexedDbPersistence = function(t3, e) {
    return function(t4, e2) {
      ...
      return Fa2(n2, i, new bs(i, r2.cacheSizeBytes, e2 == null ? void 0 : e2.forceOwnership));
    }(t3.d_, {
      forceOwnership: e
    });
    ...
    return function(t4) {
      ...
      return Fa2(e, r2, new _s(r2, n2.cacheSizeBytes));
    }(t3.d_);
...
var Nc2 = function(t2) {
  ...
  return __extends(e, t2), Object.defineProperty(e.prototype, "I_", {
    ...
    !function(t4, e3, n2) {
      var r2 = (t4 = Cs(t4, qs)).V_();
      r2.host !== "firestore.googleapis.com" && r2.host !== e3 && S2("Host has been set in both settings() and useEmulator(), emulator host will be used"), t4.g_(Object.assign(Object.assign({}, r2), {
        host: e3 + ":" + n2,
        ssl: false
      }));
    }(this.d_, t3, e2);
                  ...
                  return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(n3) {
                      switch (n3.label) {
                        ...
                        case 1:
                          return n3.sent(), e4.kh.set("Offline"), [2];
                      }
                    });
                  });
                }(n2))];
    ...
    try {
      return new jc2(this, Gs(this.d_, t3));
    } catch (t4) {
    ...
    try {
      return new Uc2(this, function(t4, e2) {
        if (t4 = Cs(t4, qs), xs("collectionGroup", "collection id", e2), e2.indexOf("/") >= 0)
        ...
        return new Fs(t4, null, function(t5) {
...
var Dc2 = function(t2) {
  ...
  return __extends(e, t2), e.prototype.get = function(t3) {
    var e2 = this, n2 = Fc2(t3);
    return this.d_.get(n2).then(function(t4) {
      return new Cc2(e2.Yf, new ac2(e2.Yf.d_, e2.Xf, t4.S_, t4.Zf, t4.metadata, n2.v_));
    });
...
var Oc2 = function(t2) {
  ...
  return __extends(e, t2), e.pd = function(t3, n2, r2) {
    ...
    return new e(n2, new js(n2.d_, r2, new tt(t3)));
  }, e.yd = function(t3, n2, r2) {
    return new e(n2, new js(n2.d_, r2, t3));
    ...
    get: function() {
      return new jc2(this.firestore, this.d_.parent);
    },
    enumerable: false,
    configurable: true
  }), Object.defineProperty(e.prototype, "path", {
    ...
    try {
      return new jc2(this.firestore, Gs(this.d_, t3));
    } catch (t4) {
      throw Pc2(t4, "collection()", "DocumentReference.collection()");
    }
  }, e.prototype.isEqual = function(t3) {
    return t3 instanceof Ds && (t3 = t3.d_), t3 instanceof js && Qs(this.d_, t3);
  }, e.prototype.set = function(t3, e2) {
    e2 = ks("DocumentReference.set", e2);
    try {
      return function(t4, e3, n2) {
        t4 = Cs(t4, js);
        var r2 = Cs(t4.firestore, Ma2), i = oc2(t4.v_, e3, n2);
    ...
    return yc2(Cs((t3 = this.d_).firestore, Ma2), [new Je(t3.S_, Re.Kt())]);
    var t3;
  }, e.prototype.onSnapshot = function() {
    for (var t3 = this, e2 = [], n2 = 0; n2 < arguments.length; n2++)
      e2[n2] = arguments[n2];
    var r2 = Lc2(e2), i = Vc2(e2, function(e3) {
      return new Cc2(t3.firestore, new ac2(t3.firestore.d_, t3.Xf, e3.S_, e3.Zf, e3.metadata, t3.d_.v_));
    });
    ...
    return ((t3 == null ? void 0 : t3.source) === "cache" ? function(t4) {
      t4 = Cs(t4, js);
      var e3 = Cs(t4.firestore, Ma2), n2 = qa2(e3), r2 = new pc2(e3);
      return function(t5, e4) {
                    ...
                    return __awaiter(this, void 0, void 0, function() {
                      ...
                      return __generator(this, function(o) {
                        switch (o.label) {
                          ...
                          case 1:
                            return (i2 = o.sent()) instanceof Pt ? n5.resolve(i2) : i2 instanceof Lt ? n5.resolve(null) : n5.reject(new q2(M2.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), [3, 3];
                          case 2:
      ...
      return new Cc2(e2.firestore, new ac2(e2.firestore.d_, e2.Xf, t4.S_, t4.Zf, t4.metadata, e2.d_.v_));
    });
  }, e.prototype.withConverter = function(t3) {
...
function Vc2(t2, e) {
  ...
  return {
    ...
    error: (n2 = (i = Ca2(t2[0]) ? t2[0] : Ca2(t2[1]) ? t2[1] : typeof t2[0] == "function" ? {
      next: t2[0],
      error: t2[1],
      complete: t2[2]
    } : {
...
var Uc2 = function(t2) {
  ...
  return __extends(e, t2), e.prototype.where = function(t3, n2, r2) {
    ...
    return ((t3 == null ? void 0 : t3.source) === "cache" ? function(t4) {
      ...
      t4 = Cs(t4, Fs);
      var e3 = Cs(t4.firestore, Ma2), n2 = qa2(e3), r2 = new pc2(e3);
      return Ha2(t4.C_), La2(n2, t4.C_).then(function(n3) {
        return new hc2(e3, r2, t4, n3);
      });
    }(this.d_)).then(function(t4) {
...
var jc2 = function(t2) {
  ...
  return __extends(e, t2), Object.defineProperty(e.prototype, "id", {
    ...
    var e2 = this;
    return function(t4, e3) {
      var n2 = Cs(t4.firestore, Ma2), r2 = Bs(t4), i = oc2(t4.v_, e3);
...
function Fc2(t2) {
  return t2 instanceof Ds && (t2 = t2.d_), Cs(t2, js);
}
/**
 * @license
 * Copyright 2017 Google LLC
...
var zc2 = function(t2) {
  ...
  return __extends(e, t2), e.documentId = function() {
    ...
    return t3 instanceof Ds && (t3 = t3.d_), t3 instanceof As && this.d_.f_.isEqual(t3.f_);
  }, e;
}(Ds);
var Gc2 = function(t2) {
  function e() {
...
var P3 = {
  ...
  DocumentSnapshot: Cc2,
  Query: Uc2,
  QueryDocumentSnapshot: Rc2,
  QuerySnapshot: qc2,
  CollectionReference: jc2,
  FieldPath: zc2,
  FieldValue: Gc2,
  setLogLevel: Sc2,
